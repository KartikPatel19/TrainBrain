...
class LiveTrain : Fragment() {
    ...
    private var mLiveTrainClass = LiveTrainClass()
    private lateinit var mLiveRouteClass: Array<LiveRouteClass?>
        ...
        call.enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                try {
                    ...
                    Objects.requireNonNull<FragmentActivity>(activity).runOnUiThread { updateUI() }
    ...
    private fun parshLiveTrainClass(JSONData: String) {
        ...
        mLiveTrainClass.responseCode = responceCode
